...
Step 7 - Fill Incident Form And Submit (Happy Path)
    ...
    # 4. ระดับความเร่งด่วน — กำหนดอัตโนมัติ (อุบัติเหตุ = เร่งด่วน)
    ...
    Input Text    xpath=//textarea    เกิดอุบัติเหตุรถชนท้ายขณะรอสัญญาณไฟแดง มีผู้ได้รับบาดเจ็บเล็กน้อย
...
Step 7b - Submit Without Image (Happy Path No File)
    ...
    # กลับไปหน้า myRoute → ยืนยันแล้ว → กดแจ้งเหตุ
